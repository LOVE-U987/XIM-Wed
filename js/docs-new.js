...
(function() {
    ...
    function initOutline() {
        ...
        if (headings.length === 0) {
            elements.outlineNav.innerHTML = '<p style="color: var(--text-muted); font-size: 0.85rem;">暂无目录</p>';
            return;
        }
        ...
        headings.forEach(heading => {
            ...
            text = text.replace(/^\d+\.\d+\s*/, '').replace(/^\d+\.\s*/, '');
        ...
        console.log('✅ 右侧大纲已生成，共', headings.length, '个标题');
    }
